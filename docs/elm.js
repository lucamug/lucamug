...
var $author$project$Main$RouteTop = {$: 'RouteTop'};
...
var $author$project$Main$RouteItem = function (a) {
	return {$: 'RouteItem', a: a};
};
var $author$project$Main$RouteList = {$: 'RouteList'};
...
var $author$project$Main$init = function (flags) {
	var newRoute = $author$project$Main$locationHrefToRoute(flags.locationHref);
	return _Utils_Tuple2(
		{route: newRoute},
		...
		switch (msg.$) {
			...
			default:
				...
				if (key === 27) {
					...
					if ((key === 37) || (key === 38)) {
						var _v1 = function () {
							var _v2 = $author$project$Main$isItemShowing(model.route);
							if (_v2.$ === 'Just') {
								var id = _v2.a;
						...
						if ((key === 39) || (key === 40)) {
							var _v4 = function () {
								var _v5 = $author$project$Main$isItemShowing(model.route);
								if (_v5.$ === 'Just') {
									var id = _v5.a;
									return $author$project$Main$previousNext(id);
								} else {
	...
	var next = function () {
		if (next_.$ === 'Just') {
			...
			return A3(
				...
				{
					label: A2($author$project$Utils$Utils$iconRight, '#000', 48),
					url: url
				});
		} else {
	...
	var previous = function () {
		if (previous_.$ === 'Just') {
			...
			return A3(
				...
				{
					label: A2($author$project$Utils$Utils$iconLeft, '#000', 48),
					url: url
				});
		} else {
			return $mdgriffith$elm_ui$Element$none;
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$String$fromInt(index + 1) + ('. ' + item.title))
											])),
										A2(
										$elm$html$Html$p,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text(item.review)
											]))
									]));
						}),
					$author$project$Book$Book$items);
						...
						_Utils_ap(
							_List_fromArray(
								[
									...
									function () {
									var _v1 = $author$project$Main$isItemShowing(model.route);
									if (_v1.$ === 'Nothing') {
							...
							function () {
								var _v3 = $author$project$Main$isItemShowing(model.route);
								if (_v3.$ === 'Nothing') {
									return _List_Nil;
								} else {
									var id = _v3.a;
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'locationHref', $elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"DoNothing":[],"InternalLinkClicked":["String.String"],"UrlChanged":["Main.Route"],"KeyDown":["Basics.Int"],"CloseModal":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Main.Route":{"args":[],"tags":{"RouteTop":[],"RouteList":[],"RouteItem":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));