...
viewTitle =
    column []
        ...
        , row [ spacing 20 ]
            ...
            , newTabLink [] { label = Utils.Utils.logoTwitter 30, url = "https://twitter.com/luca_mug" }
...
cardWrapper :
    ...
    -> String
    -> Element msg
cardWrapper linkInternal _ item url =
    el
...
items : List Item
items =
    [ { title = "🍒 Functional Pac-Man, an interpretation of the game, written in purely functional code (Gren) that run in the browser and in the terminal"
